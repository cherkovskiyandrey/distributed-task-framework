...
public class BatchCancelCommand extends AbstractBatchTaskBasedCommand implements LocalCommand {

    protected BatchCancelCommand(List<TaskEntity> taskEntities) {
        super(taskEntities);
    }

    @Override
    public void execute(InternalTaskCommandService internalTaskCommandService) {
        internalTaskCommandService.cancelAll(taskEntities);
    }
}

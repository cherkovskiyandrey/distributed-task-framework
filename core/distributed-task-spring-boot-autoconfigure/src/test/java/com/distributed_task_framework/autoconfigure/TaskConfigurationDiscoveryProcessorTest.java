...
class TaskConfigurationDiscoveryProcessorTest {
    ...
    @Test
    void shouldRegistryLocalTaskWithInterceptorsFromCode() throws Exception {
        //when
    ...
    @Test
    void shouldRegistryLocalTaskWithExcludedCommonInterceptorsFromCode() throws Exception {
        //when
    ...
    @Test
    void shouldAppendAndDeduplicateExcludedCommonInterceptorsFromFileAndCode() throws Exception {
        //when
        TaskWithExcludedCommonInterceptors task = new TaskWithExcludedCommonInterceptors();
        when(properties.getTaskPropertiesGroup()).thenReturn(DistributedTaskProperties.TaskPropertiesGroup.builder()
            .taskProperties(Map.of(
    ...
    @Test
    void shouldRegistryLocalTaskWithDefaultInterceptorsFromFile() throws Exception {
        //when
        when(properties.getTaskPropertiesGroup()).thenReturn(DistributedTaskProperties.TaskPropertiesGroup.builder()
            .defaultProperties(DistributedTaskProperties.TaskProperties.builder()
                .creationInterceptors(List.of(TestCreationInterceptor.class))
    ...
    @Test
    void shouldAppendAndDeduplicateInterceptorsFromFileAndCode() throws Exception {
        //when
        TaskWithInterceptors task = new TaskWithInterceptors();
        when(properties.getTaskPropertiesGroup()).thenReturn(DistributedTaskProperties.TaskPropertiesGroup.builder()
            .defaultProperties(DistributedTaskProperties.TaskProperties.builder()

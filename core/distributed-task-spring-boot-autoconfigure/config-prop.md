...
| excluded-common-creation-interceptors| java.util.List&lt;java.lang.Class&lt;? extends com.distributed_task_framework.interceptor.CommonTaskCreationInterceptor&gt;&gt;| Common creation interceptors excluded for the task, combined with annotations and deduplicated. Prohibited in default-properties (application startup fails).| | | 
| excluded-common-execution-interceptors| java.util.List&lt;java.lang.Class&lt;? extends com.distributed_task_framework.interceptor.CommonTaskExecutionInterceptor&gt;&gt;| Common execution interceptors excluded for the task, combined with annotations and deduplicated. Prohibited in default-properties (application startup fails).| | | 
